...
mv %{buildroot}/usr/lib/lib/python3.9/site-packages/*.py* %{buildroot}/usr/lib/baltrad-viewer/Lib/
mv %{buildroot}/usr/lib/lib/python3.9/site-packages/*.egg-info %{buildroot}/usr/lib/baltrad-viewer/Lib/
rm -fr %{buildroot}/usr/lib/lib/python3.9/site-packages/__pycache__
