...
MODULES="hlhdf rave baltrad-beast baltrad-config baltrad-crypto baltrad-db baltrad-exchange baltrad-dex baltrad-node-tomcat baltrad-ppc baltrad-utils baltrad-viewer baltrad-wrwp bbufr beamb bropo hdf-java"
