...
#XXX ./scripts/build_package.sh bropo               $PKG_BUILD_NUMBER || print_error_and_exit "Failed to build bropo"
#./scripts/build_package.sh beamb               $PKG_BUILD_NUMBER || print_error_and_exit "Failed to build beamb"
#XXX ./scripts/build_package.sh baltrad-wrwp        $PKG_BUILD_NUMBER || print_error_and_exit "Failed to build baltrad-wrwp"
